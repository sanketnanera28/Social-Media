...
def signup(request):
    try:
        ...
        invalid = "User already exists or another error occurred"
        return render(request, 'signup.html', {'invalid': invalid, 'error': str(e)})
...
def search_results(request):
    ...
    users = Profile.objects.select_related('user').filter(user__username__icontains=query)
